...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $uploadsPath = $rootPath . "/lms/uploads/";
    ...
    $sql = "INSERT INTO products (product_name, price, quantity, image)
            VALUES (?, ?, ?,?)";

    $stmt = mysqli_prepare($conn, $sql);
    mysqli_stmt_bind_param($stmt, "ssss",$productName, $price, $quantity, $targetFile);
