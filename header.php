...
<html class="no-js">
    <head>
        <title>HandCraftAdministrative System</title>
		<meta name="description" content="Learning Management System">
		<meta name="keywords" content="HANDY LMS,ONLINE,EDUCATION,LMS,LEARNING">
		<meta name="author" content="">
		<meta charset="UTF-8">
        <!-- Bootstrap -->
				<link href="admin/images/favicon.ico" rel="icon" type="image">
				<!-- <link rel="stylesheet" href="/admin/bootstrap/css/index - Copy.css"> -->
				<!-- <link rel="stylesheet" href="/admin/bootstrap/css/index.css"> -->
