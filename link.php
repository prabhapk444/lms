...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css" integrity="sha512-nhJBs66xmLPeFlIWETJDXJxu6b/WwZ+jjp5h0Xc29s7Dpd3d8+L3qEU+rnjPByNrptA03lqXItC4hwxRiivqPQ==" crossorigin="anonymous" referrerpolicy="no-referrer" />
<div class="navbar">
		...
		<li class="active"><a href="index.php"><i class="icon-home"></i>&nbsp;Home</a></li>
			<li class="divider-vertical"></li>
			<li>
    <a href="productslogin.php">
        <i class="icon-cart"></i>&nbsp;handiproducts
    </a>
	<li><a href="./productsadmin/adminlogin.php">Admin</a></li>
